...
const ResponsiveCard1 = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row bg-white shadow-lg mx-auto my-10 w-full md:w-[80%] h-auto md:h-[400px] overflow-hidden">
      ...
      >
        <h2 className="text-3xl font-bold mb-4 text-black">Our Achievements</h2>
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col md:flex-row md:space-x-6 space-y-6 md:space-y-0">
            ...
            >
              ...
              <div className=''>
              <h3 className="text-xl font-semibold"><CountUp
                start={-20000000}
                end={25}
                duration={2}
                suffix="+"
              ...
              /></h3>
              <p className='text-black'>We reached 25+ new milestones in the past year.</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-semibold"><CountUp
                ...
                className="text-yellow-400 text-4xl font-bold"
              /></h3>
              <p className='text-black'>We have maintained a 97% efficiency rate in our operations.</p>
            </motion.div>
          </div>
        </div>
      </motion.div>
...
export default ResponsiveCard1;
