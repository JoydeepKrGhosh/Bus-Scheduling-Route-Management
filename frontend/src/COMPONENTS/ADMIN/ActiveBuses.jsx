...
function ActiveBuses({ darkMode, handleCardClick }) {
  const [buses, setBuses] = useState([
    { id: 'DTC-101', type: 'AC', currentRoute: 'Route 1', progress: 100, location: 'Destination' },
    { id: 'DTC-102', type: 'Non-AC', currentRoute: 'Route 2', progress: 0, location: 'Bus Stand' },
    { id: 'DTC-103', type: 'AC', currentRoute: 'Route 3', progress: 50, location: 'En Route' },
    { id: 'DTC-104', type: 'Non-AC', currentRoute: 'Route 4', progress: 20, location: 'Bus Stand' },
  ]);
